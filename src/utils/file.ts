...
export async function normalizeInput(input: NodeInput): Promise<Buffer> {
  ...
  throw new InvalidInputError("Input must be a file path (string) or Buffer", typeof input)
}

export function generateOutputFilename(inputPath: string, outputDir?: string): string {
